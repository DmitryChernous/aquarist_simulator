...
export const FISH_SPECIES: FishSpecies[] = [
  {
    id: 'neon', name: 'Неон обыкновенный', latin: 'Paracheirodon innesi', color: '#3f8bff',
  ...
  {
    id: 'guppy', name: 'Гуппи', latin: 'Poecilia reticulata', color: '#ff8c42',
  ...
  {
    id: 'danio', name: 'Данио-рерио', latin: 'Danio rerio', color: '#6aa9ff',
  ...
  {
    id: 'swordtail', name: 'Меченосец', latin: 'Xiphophorus hellerii', color: '#ff4f4f',
  ...
  {
    id: 'goldfish', name: 'Золотая рыбка', latin: 'Carassius auratus', color: '#ffb03a',
  ...
  {
    id: 'angelfish', name: 'Скалярия', latin: 'Pterophyllum scalare', color: '#cdd6e6',
  ...
  {
    id: 'mbuna', name: 'Цихлида мбуна', latin: 'Pseudotropheus sp.', color: '#2a6bff',
  ...
  {
    id: 'discus', name: 'Дискус', latin: 'Symphysodon discus', color: '#3affd0',
